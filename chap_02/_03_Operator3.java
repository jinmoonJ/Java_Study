...
public class _03_Operator3 {
    public static void main(String[] args) {
        ...
        System.out.println(5 >= 3); // 5 는 3 보다 크거나 같다 (참 -> true)
        System.out.println(5 >= 5); // 5 는 5 보다 크거나 같다 (참 -> true)
        System.out.println(5 >= 7); // 5 는 7 보다 크거나 같다 (거짓 -> false)
        ...
        System.out.println(5 == 5); // 5 와 5 는 같다 (true)
